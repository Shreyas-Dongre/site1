    ...
    <main className="container relative mx-auto scroll-my-12 overflow-auto p-4 print:p-12 md:p-16">
      <section className="mx-auto w-full max-w-2xl space-y-8 print:space-y-4">
        ...
        <Section>
          ...
          {RESUME_DATA.Recognitions.map((Recognitions) => {
            return (
              <Card key={Recognitions.company} className="border p-3 shadow-sm">
                <CardHeader>
                  <div className="flex items-center justify-between gap-x-2 text-base">
                    <h3 className="inline-flex items-center justify-center gap-x-1 font-semibold leading-none">
                      <a className="hover:underline" href={Recognitions.link}>
                        {Recognitions.company}
                      </a>

                      <span className="inline-flex gap-x-1">
                        {Recognitions.badges.map((badge) => (
                          <Badge
                            variant="secondary"
                            className="align-middle text-xs print:px-1 print:py-0.5 print:text-[8px] print:leading-tight"
                            key={badge}
                    ...
                    <div className="text-sm tabular-nums text-gray-500">
                      {Recognitions.start} - {Recognitions.end ?? "Present"}
                    </div>
                  </div>
